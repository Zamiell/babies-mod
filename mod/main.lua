...
function ____exports.spawnRandomPickup(self, position, velocity, noItems)
    ...
    g.run.randomSeed = ____exports.incrementRNG(nil, g.run.randomSeed)
    local ____switch51 = pickupVariant
    if ____switch51 == 1 then
        goto ____switch51_case_0
    elseif ____switch51 == 2 then
        goto ____switch51_case_1
    elseif ____switch51 == 3 then
        goto ____switch51_case_2
    elseif ____switch51 == 4 then
        goto ____switch51_case_3
    elseif ____switch51 == 5 then
        goto ____switch51_case_4
    elseif ____switch51 == 6 then
        goto ____switch51_case_5
    elseif ____switch51 == 7 then
        goto ____switch51_case_6
    elseif ____switch51 == 8 then
        goto ____switch51_case_7
    elseif ____switch51 == 9 then
        goto ____switch51_case_8
    elseif ____switch51 == 10 then
        goto ____switch51_case_9
    elseif ____switch51 == 11 then
