...
### _v1.15.0_ - September 14th, 2023 (Unreleased)

- Changed the following babies:
  - Beanie Baby (#465) - Starts with Spelunker Hat
...
- Changed the following babies:
  ...
  - Basic Spider Baby (#214) - Starts with Breath of Life
...
- Changed the following babies:
  ...
  - Sword Baby (#312) - Starts with Piggy Bank + Swallowed Penny + Strawman (Strawman must not die)
...
- Skull Baby (#211) - Shockwave bombs - The shockwaves no longer deal damage to the player.
