...
PostLaserUpdate.functions[14] = function(laser)
  ...
  if data ~= nil and data.ring == true then
...
PostLaserUpdate.functions[51] = function(laser)
  if (
    laser.SpawnerType == EntityType.ENTITY_PLAYER -- 1
    and laser.FrameCount == 0
  ) then
    ...
    -- we will instead hardcode the default Azazel distance
