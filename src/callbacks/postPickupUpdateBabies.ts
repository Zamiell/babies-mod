...
// Bugeyed Baby
functionMap.set(131, (pickup: EntityPickup) => {
...
// No Arms Baby
functionMap.set(140, (pickup: EntityPickup) => {
  if (
    pickup.Variant !== PickupVariant.PICKUP_COLLECTIBLE && // 100
    pickup.Variant !== PickupVariant.PICKUP_SHOPITEM && // 150
    pickup.Variant !== PickupVariant.PICKUP_BIGCHEST && // 340
...
// Rictus Baby
functionMap.set(154, (pickup: EntityPickup) => {
  if (
    pickup.Variant !== PickupVariant.PICKUP_COLLECTIBLE && // 100
    pickup.Variant !== PickupVariant.PICKUP_SHOPITEM && // 150
    pickup.Variant !== PickupVariant.PICKUP_BIGCHEST && // 340
...
// Spike Baby
functionMap.set(166, (pickup: EntityPickup) => {
...
// Aban Baby
functionMap.set(177, (pickup: EntityPickup) => {
...
// Suit Baby
functionMap.set(287, (pickup: EntityPickup) => {
...
// Cowboy Baby
functionMap.set(394, (pickup: EntityPickup) => {
  // Pickups shoot
  if (
...
// Fate's Reward
functionMap.set(537, (pickup: EntityPickup) => {
