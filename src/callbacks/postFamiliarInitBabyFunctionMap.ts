...
postFamiliarInitBabyFunctionMap.set(30, (familiar: EntityFamiliar) => {
  // Making the Sprinkler invisible. (Setting "familiar.Visible = false" does not work, so blank out
  // the sprite.)
...
postFamiliarInitBabyFunctionMap.set(47, (familiar: EntityFamiliar) => {
  // Make the Succubus invisible. (Setting "familiar.Visible = false" does not work because it will
  // also make the aura invisible.)
